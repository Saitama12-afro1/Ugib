...
function current_height(area){
  ...
  function TSNIGRI_validation(choise){
    ...
    var pattern =/[0-9][0-9][0-9][0-9]_Пр\s[0-9][0-9]$/
    var pattern2 = /[0-9][0-9][0-9][0-9]_Пр\s[0-9][0-9]_[0-9][0-9]_[а-яА-ЯЁё]+(\s[а-яА-ЯЁё]+)?/
    ...
    function showError() {
        error.textContent = "Не соответствует шаблону моему"
